      ...
      <div className="text-center mb-12">
        <div className="flex items-center justify-center gap-4 mb-6">
          <div className="relative">
            <div className="absolute inset-0 bg-brand-500 rounded-2xl blur-lg opacity-30 animate-pulse-slow"></div>
            <div className="relative bg-gradient-to-br from-brand-500 to-brand-600 p-4 rounded-2xl shadow-brand">
              <Target className="h-8 w-8 text-white icon-hover" />
            </div>
          </div>
          <div className="text-left">
            <h1 className="text-4xl font-bold text-neutral-50 font-inter tracking-tight mb-2">
              Prospecção
              <span className="bg-gradient-to-r from-brand-400 to-brand-600 bg-clip-text text-transparent ml-2">
                Premium
              </span>
            </h1>
        ...
        <div className="stats-card group">
          <div className="flex items-center justify-between mb-4">
            <div className="flex-1">
              ...
              <p className="text-3xl font-bold text-neutral-50 font-inter tracking-tight mb-3">
                1,247
              </p>
              <div className="w-full bg-neutral-800 rounded-full h-2 overflow-hidden">
                <div className="bg-gradient-to-r from-brand-500 to-brand-400 h-2 rounded-full transition-all duration-1000 ease-out" 
                     style={{ width: '75%' }}>
            ...
            <div className="bg-gradient-to-br from-brand-500/20 to-brand-600/10 p-3 rounded-xl border border-brand-500/20">
              <BarChart3 className="h-6 w-6 text-brand-400 icon-hover" />
            </div>
          </div>
        </div>
