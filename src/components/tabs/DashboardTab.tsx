...
export const DashboardTab = ({ onSearch, isLoading }: DashboardTabProps) => {
  return (
    <div className="max-w-6xl mx-auto space-y-8 fade-in">
      ...
      <div className="text-center mb-12">
        <div className="flex items-center justify-center gap-4 mb-6">
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-youtube-red to-red-600 p-4 rounded-2xl shadow-lg border border-youtube-red/20">
              <Target className="h-8 w-8 text-youtube-white transition-transform duration-200 hover:scale-105" />
            </div>
          </div>
          <div className="text-left">
            ...
            <p className="text-neutral-300 text-lg font-inter font-medium">
      ...
      {/* Cards de Estatísticas modernizados com tons de cinza */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
        <div className="modern-stats-card group">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="bg-neutral-800/80 backdrop-blur-sm p-3 rounded-xl border border-neutral-700/50 transition-all duration-200 hover:border-youtube-red/30 hover:bg-neutral-700/80">
              <BarChart3 className="h-6 w-6 text-youtube-red transition-transform duration-200 hover:scale-110" />
            </div>
          </div>
        </div>
        ...
        <div className="modern-stats-card group">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="bg-neutral-800/80 backdrop-blur-sm p-3 rounded-xl border border-neutral-700/50 transition-all duration-200 hover:border-emerald-500/30 hover:bg-neutral-700/80">
              <TrendingUp className="h-6 w-6 text-emerald-400 transition-transform duration-200 hover:scale-110" />
            </div>
          </div>
        </div>
        ...
        <div className="modern-stats-card group">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="bg-neutral-800/80 backdrop-blur-sm p-3 rounded-xl border border-neutral-700/50 transition-all duration-200 hover:border-blue-500/30 hover:bg-neutral-700/80">
              <Users className="h-6 w-6 text-blue-400 transition-transform duration-200 hover:scale-110" />
            </div>
          </div>
        </div>
      </div>
