...
export const PremiumHeader = () => {
  return (
    <div className="border-b border-youtube-red bg-neutral-900 relative overflow-hidden">
      {/* Futuristic Background Pattern */}
      <div className="absolute inset-0 opacity-10">
        <div 
          className="absolute inset-0" 
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23CC2936' fill-opacity='0.2'%3E%3Cpath d='M30 30l15-10v20z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`
          }}
        ></div>
      </div>

      {/* Top accent line with glow effect */}
      <div className="absolute top-0 left-0 right-0 h-1 bg-youtube-red shadow-[0_0_10px_rgba(204,41,54,0.6)]"></div>
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-6 mb-6">
            ...
            <div className="relative group">
              <div className="bg-youtube-red p-3 rounded-lg shadow-xl transform group-hover:scale-105 transition-all duration-300 border border-youtube-red futuristic-glow">
                <div className="relative">
                  ...
                  <div className="absolute -top-1 -right-1 bg-neutral-900 rounded-full p-1 border border-youtube-white shadow-lg">
            ...
            <div className="text-left">
              ...
              <p className="text-neutral-400 text-xs font-bold tracking-widest uppercase mt-2 font-roboto">
                YouTube Prospecting Pro
              </p>
            </div>
          </div>
          
          <p className="text-base text-neutral-400 max-w-3xl mx-auto leading-relaxed font-light font-roboto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <Card className="tech-card group">
            <CardContent className="p-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-neutral-400 text-xs font-medium mb-1 font-roboto">Canais Analisados</p>
          ...
          <Card className="tech-card group">
            <CardContent className="p-3">
              <div className="flex items-center gap-3">
                <div className="bg-neutral-800 p-2 rounded-lg shadow-md group-hover:scale-110 transition-transform duration-300 border border-youtube-red">
                  <TrendingUp className="h-4 w-4 text-youtube-white" />
                </div>
                <div>
                  <p className="text-neutral-400 text-xs font-medium mb-1 font-roboto">Taxa de Sucesso</p>
          ...
          <Card className="tech-card group">
            <CardContent className="p-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-neutral-400 text-xs font-medium mb-1 font-roboto">Análises Premium</p>
      ...
      {/* Bottom accent line */}
      <div className="absolute bottom-0 left-0 right-0 h-px bg-youtube-red shadow-[0_0_5px_rgba(204,41,54,0.5)]"></div>
    </div>
  );
};
