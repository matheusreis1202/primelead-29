          ...
          return (
            ...
            >
              <CardContent className="p-6">
                ...
                {index < 3 && (
                  <div className="absolute -top-3 -right-3 bg-youtube-red text-youtube-white text-sm font-bold px-3 py-2 rounded-md shadow-xl border-2 border-youtube-black futuristic-glow font-orbitron">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className={`bg-gradient-to-r ${getScoreColor(channel.score)} p-3 rounded-lg text-youtube-white shadow-md futuristic-glow`}>
                    <ScoreIcon className="h-6 w-6" />
                  </div>
                  <div className="text-right">
                    <div className={`text-2xl font-bold ${getScoreTextColor(channel.score)} font-orbitron`}>
                      {channel.score}/100
                    </div>
                ...
                <div className="flex items-start gap-3 mb-4">
                  {channel.thumbnail && (
                    <img 
                      ...
                      alt={channel.title}
                      className="w-16 h-16 rounded-lg border-2 border-youtube-gray group-hover:border-youtube-red transition-colors shadow-sm"
                    />
                  )}
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-youtube-white text-lg leading-tight mb-2 line-clamp-2 group-hover:text-youtube-gray transition-colors font-orbitron">
                      {channel.title}
                    </h3>
                ...
                {channel.description && (
                  <div className="mb-6">
                    <p className="text-sm text-youtube-gray line-clamp-2 bg-youtube-dark p-3 rounded-lg border border-youtube-red font-inter">
                      {channel.description}
                    </p>
                  </div>
                )}
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-center justify-between text-sm bg-youtube-dark p-3 rounded-lg border border-youtube-red">
                    <div className="flex items-center gap-2 text-youtube-gray">
                      <div className="bg-youtube-red p-1.5 rounded-md futuristic-glow">
                  ...
                  {/* Engagement Rate */}
                  <div className="flex items-center justify-between text-sm p-3 rounded-lg border bg-youtube-dark border-green-500">
                    <div className="flex items-center gap-2">
                      <div className="bg-green-500 p-1.5 rounded-md futuristic-glow">
                ...
                <div className="flex flex-col gap-3">
                  <Button 
                    asChild 
                    className="w-full futuristic-button py-2 rounded-md font-orbitron text-sm"
                  >
                    <a 
                  ...
                  <Button 
                    asChild 
                    variant="outline" 
                    className="w-full border-youtube-red bg-youtube-dark text-youtube-white hover:bg-youtube-red hover:border-youtube-red py-2 rounded-md transition-all duration-300 font-inter text-sm"
                  >
                    <a 
